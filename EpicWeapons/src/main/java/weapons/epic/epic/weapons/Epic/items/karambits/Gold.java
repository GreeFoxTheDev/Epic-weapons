...
public class Gold extends JavaPlugin {
    ...
    public static ItemStack goldKarambit;
    private static void createGoldKarambit() {
        ItemStack item = new ItemStack(Material.GOLDEN_SWORD, 1);
        ItemMeta im = item.getItemMeta();
        im.setDisplayName("§fGolden Karambit");
        im.setLocalizedName("gold_karambit");
        ...
        AttributeModifier damage = new AttributeModifier(UUID.randomUUID(), "generic.attackDamage", 1.5, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.HAND);
        ...
        lore.add(ChatColor.DARK_GREEN + " 1.5 attack damage");
        ...
        item.setItemMeta(im);
        goldKarambit = item;
        ShapedRecipe sr = new ShapedRecipe(NamespacedKey.minecraft("gold_karambit"), item);
        sr.shape(" X ",
                " Y ",
                "  Z");
